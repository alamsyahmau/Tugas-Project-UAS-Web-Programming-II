...
<body>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Kategori Menu</h2>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body border-bottom collapse" id="tambah">
                                <form method="post" action="<?php echo site_url('kategori_menu/add') ?>">
    ...
    <script>
        let read_url = '<?php echo site_url('kategori_menu/read') ?>'
        let edit_url = '<?php echo site_url('kategori_menu/edit') ?>'
        let hapus_url = '<?php echo site_url('kategori_menu/delete') ?>'
    </script>
    <script src="<?php echo base_url() ?>assets/js/menu/kategori_menu.js"></script>
</body>
