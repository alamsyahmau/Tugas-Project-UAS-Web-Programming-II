...
<body>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Data Menu</h2>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body border-bottom collapse" id="tambah">
                                <form method="post" action="<?php echo site_url('menu/add') ?>">
                                    <div class="info"></div>
    ...
    <script>
        let read_url = '<?php echo site_url('menu/read') ?>'
        let edit_url = '<?php echo site_url('menu/edit') ?>'
        let hapus_url = '<?php echo site_url('menu/delete') ?>'
        let get_kategori_url = '<?php echo site_url('kategori_menu/get_kategori') ?>'
